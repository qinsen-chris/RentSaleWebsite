...
public class ErrorInfo {
	...
	/** 不需要回滚的业务请求失败 */
	public static final int CODE_NO_ROLLBACK = -40000;
	/** 网络链接错误 */
	public static final int CODE_NETWORK_ERROR = -50000;
	/** 三方－汇付 */
	public static final int CODE_PARTERNER_HUIFU_ERROR = -60000;
	/** 平台－营销 */
	public static final int CODE_PLATFORM_MARKETING_ERROR = -71000;
	/** 平台－邮件、短信 */
	public static final int CODE_PLATFORM_Message = -72000;
	/** 重复交易 */
	public static final int CODE_DUPLICATE_ERROR = -80000;
