...
public class MyTags extends FastTags{
	...
	public static void _page(Map<String, Object> params, Closure body, PrintWriter out, 
		...
		String submitMethod = (String) params.get("submitMethod");
		String pageInputId = (String) params.get("pageInputId");
		...
		page.style = style;
		if (StringUtils.isNotEmpty(submitMethod)){
			page.submitMethod = submitMethod;
		}
		if (StringUtils.isNotEmpty(pageInputId)){
			page.pageInputId = pageInputId;
		}
		if(condition != null) {
